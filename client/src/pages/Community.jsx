      ...
      <div className="bg-white h-full w-full rounded-xl overflow-y-scroll flex flex-wrap">
        {creations.map((creation, index) => (
          ...
          >
            ...
            />
            <div className="absolute bottom-0 top-0 right-0 left-3 flex gap-2 items-end justify-end group-hover:bg-gradient-to-b from-transparent to-black/80 text-white rounded-lg p-2">
